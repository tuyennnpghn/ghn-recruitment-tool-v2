...
async function main() {
  ...
  // ============================================================
  // 2. DEPARTMENTS (17 records from Annex_request)
  // ============================================================
  const departments = [
  ...
  // ============================================================
  // 3. LEVELS (23 records with lead-time from Prompt)
  // ============================================================
  const levels = [
    ...
    { name: 'Consultant (Project-based)', leadTimeDays: null }, // N/A
  ...
  // ============================================================
  // 5. CV SOURCES (32 Channel Names from Annex_cdd)
  // ============================================================
  const cvSources = [
    // Job Post
  ...
  // ============================================================
  // 6. HOLIDAY CALENDAR 2026 (Vietnam Official Holidays)
  // ============================================================
  const holidays2026 = [
  ...
  // ============================================================
  // 7. JOB TITLES — S-GRADE MAPPING (sample — full 211 from Annex_request)
  // ============================================================
  // Get department IDs
  ...
  // S-Grade mapping: [dept_code, title, s_grade]
  // This is a representative sample — the full 211 entries will be loaded via Admin import
  const sGradeMappings: [string, string, string | null][] = [
    // S1 — Executive, Officer, Staff
    ...
    // S2 — Specialist, Senior Exec, Engineer
    ...
    ['TEC', 'Engineer 1', 'S2'],
    ['TEC', 'Engineer 2', 'S2'],
    // S3 — Team Leader, Supervisor, Senior Specialist
  ...
  // ============================================================
  // 8. CV SOURCES — exact names from requirements (32 records)
  // ============================================================
  const reqCvSources = [
  ...
  // ============================================================
  // 9. LEVELS — exact names from requirements (22 records)
  //    update: {} preserves any existing leadTimeDays values
  // ============================================================
  const reqLevels = [
  ...
  // ============================================================
  // 10. NEW DEPARTMENTS + 194 JOB TITLE S-GRADE RECORDS
  // ============================================================
  const newDepts = [
  ...
  const jobTitleData: { dept: string; title: string; sGrade: string | null }[] = [
  ...
  for (const jt of jobTitleData) {
    ...
    if (!departmentId) { console.warn(`  ⚠️ Dept not found: ${jt.dept}`); jtSkipped++; continue; }
    await prisma.jobTitle.upsert({
